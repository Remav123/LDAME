...
Inspired by MAME, LDAME seeks to provide a portable, future-proof representation of LaserDisc titles that preserves their structure, navigation, audio options, and unique behaviors while allowing multiple video sources to be used.
...
| Frame | Event |
|---------|---------|
| 000000 | Start of disc |
| 051234 | Chapter 18 |
| 054000 | Side A ends |
| 054001 | Side B begins |
...
The project is currently focused on defining formats, metadata structures, and preservation goals before implementation begins.
